...
fun App(navController: NavHostController) {
    ...
    NavHost(
        ...
        composable("home") {
            Home {
                val json = jsonAdapter.toJson(it.split(", ").map { studentString -> Student(studentString.removeSurrounding("Student(name=", ")")) })
        ...
        composable(
            ...
            val students = jsonAdapter.fromJson(json) ?: emptyList()
            ResultContent(
                students = students
            )
        }
